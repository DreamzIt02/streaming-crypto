...
#[cfg(test)]
mod tests {
    use streaming_crypto::{headers::{HeaderV1, Strategy}, parallelism::ParallelismConfig, stream::{InputSource, OutputSink, core::{MasterKey}}, v2::{ApiConfig, EncryptParams, DecryptParams, encrypt_stream_v2, decrypt_stream_v2}};
