...
mod tests {
    use core_api::{
        ...
        stream::{
            ...
            core::MasterKey, 
        }, v3::core::validate_encrypt_params,
    };
    use core_api::v3::{core::{ApiConfig, DecryptParams, EncryptParams, validate_decrypt_params, validate_dictionary, decrypt_stream_v3, encrypt_stream_v3 }};
    ...
    fn encrypt_and_decrypt_roundtrip() {
        ...
        // Encrypt
        let snapshot_enc = encrypt_stream_v3(input, output, params_enc, config.clone())
            .expect("encryption should succeed");
        ...
        let snapshot_dec = decrypt_stream_v3(input_dec, output_dec, params_dec, config)
            .expect("decryption should succeed");
    ...
    fn encrypt_stream_with_invalid_key_should_fail() {
        ...
        let result = encrypt_stream_v3(input, output, params_enc, config);
    ...
    fn decrypt_stream_with_invalid_key_should_fail() {
        ...
        let result = decrypt_stream_v3(input, output, params_dec, config);
