...
mod tests {
    ...
    use core_api::v3::{core::{ApiConfig, DecryptParams, EncryptParams, validate_decrypt_params, validate_dictionary, validate_encrypt_params, decrypt_stream_v3, encrypt_stream_v3 }};
