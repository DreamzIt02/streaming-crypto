...
macro_rules! bench_v3_encrypt_file {
    ($out_variant:ident, $out_expr:expr) => {
        paste::paste! {
            pub fn [<bench_v3_encrypt_file_2_ $out_variant:lower _sync>](
...
bench_v3_encrypt_file!(Memory, OutputSink::Memory);

// Encrypt from File → File
bench_v3_encrypt_file!(File, OutputSink::File(PathBuf::from("encrypted_file.dat")));

// Encrypt from File → Writer
bench_v3_encrypt_file!(Writer, OutputSink::Writer(Box::new(Vec::new())));

// ### 📂 Expanded Functions
// This generates three functions:

// - `bench_v3_encrypt_file_2_memory_sync`
// - `bench_v3_encrypt_file_2_file_sync`
// - `bench_v3_encrypt_file_2_writer_sync`
...
//     // Encrypt from File → Memory
//     let (res_mem, ciphertext_mem, _) = bench_v3_encrypt_file_2_memory_sync(
...
//     // Encrypt from File → File
//     let (res_file, _, file_path) = bench_v3_encrypt_file_2_file_sync(
//         chunk_size, compression, parallelism
//     );
...
//     // Encrypt from File → Writer
//     let (res_writer, ciphertext_writer, _) = bench_v3_encrypt_file_2_writer_sync(
//         chunk_size, compression, parallelism
//     );
