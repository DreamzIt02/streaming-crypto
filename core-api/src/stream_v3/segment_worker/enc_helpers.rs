...
use crate::{
    ...
    stream_v3::{pipeline::{Monitor, PipelineMonitor}, segment_worker::SegmentInput}, telemetry::{Stage, StageTimes, TelemetryCounters, TelemetryEvent}, types::StreamError, utils::tracing_logger
};
...
pub fn process_encrypt_segment_3(
    ...
    let cancel_rx = monitor.cancel_rx().clone();
