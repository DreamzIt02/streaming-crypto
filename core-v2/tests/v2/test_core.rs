...
mod tests {
    ...
    use core_v2::core::{ApiConfig, DecryptParams, EncryptParams, decrypt_stream_v2, encrypt_stream_v2, validate_decrypt_params, validate_dictionary, validate_encrypt_params};
